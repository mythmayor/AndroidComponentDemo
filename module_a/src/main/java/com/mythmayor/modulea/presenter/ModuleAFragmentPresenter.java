 ...
 */
public class ModuleAFragmentPresenter extends BasePresenter<ModuleAFragmentContract.View> implements ModuleAFragmentContract.Presenter {

    private ModuleAFragmentContract.Model mModel;

    public ModuleAFragmentPresenter() {
