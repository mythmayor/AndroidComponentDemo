 ...
 */
public class DFragmentViewModel extends ViewModel {

    private DFragmentModel mModel;

    public DFragmentViewModel() {
        mModel = new DFragmentModel();
    }

    public void getUserInfo(DFragment view, UserInfoRequest request) {
