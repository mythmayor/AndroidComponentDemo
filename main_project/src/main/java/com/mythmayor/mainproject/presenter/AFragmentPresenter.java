...
import com.mythmayor.mainproject.model.AFragmentModel;
 ...
 */
public class AFragmentPresenter extends BasePresenter<AFragmentContract.View> implements AFragmentContract.Presenter {

    private AFragmentContract.Model mModel;

    public AFragmentPresenter() {
        mModel = new AFragmentModel();
    }
