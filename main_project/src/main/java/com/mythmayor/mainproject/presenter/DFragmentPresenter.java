...
import com.mythmayor.mainproject.model.DFragmentModel;
 ...
 */
public class DFragmentPresenter extends BasePresenter<DFragmentContract.View> implements DFragmentContract.Presenter {

    private DFragmentContract.Model mModel;

    public DFragmentPresenter() {
        mModel = new DFragmentModel();
    }
