package com.mythmayor.modulec.viewmodel;
...
import com.mythmayor.modulec.model.ModuleCFragmentModel;
import com.mythmayor.modulec.ui.fragment.ModuleCFragment;
 ...
 */
public class ModuleCFragmentViewModel extends ViewModel {

    private ModuleCFragmentModel mModel;

    public ModuleCFragmentViewModel() {
        mModel = new ModuleCFragmentModel();
    }

    public void getUserInfo(ModuleCFragment view, UserInfoRequest request) {
