 ...
 */
public class ModuleDFragmentPresenter extends BasePresenter<ModuleDFragmentContract.View> implements ModuleDFragmentContract.Presenter {

    private ModuleDFragmentContract.Model mModel;

    public ModuleDFragmentPresenter() {
        mModel = new ModuleDFragmentModel();
    }
