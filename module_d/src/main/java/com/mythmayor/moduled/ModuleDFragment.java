...
public class ModuleDFragment extends BaseMvvmFragment<ModuleDFragmentViewModel, FragmentDBinding> {
    ...
    protected void initMvvmEvent() {
        ...
        mViewDataBinding.ivAvatar.setOnClickListener(this);
    ...
    protected void initMvvmData() {
        ...
        if (loginInfo != null) {
            mViewDataBinding.tvName.setText(loginInfo.getNickname());
        } else {
    ...
    public void onClick(View v) {
        ...
        } else if (v == mViewDataBinding.ivAvatar) {
            //selectPicture();
                    ...
                    .forResult(new OnResultCallbackListener<LocalMedia>() {
                        ...
                        public void onResult(List<LocalMedia> result) {
                            for (LocalMedia media : result) {
                                ...
                                GlideUtil.loadCircleImage(PictureMimeType.isContent(path) && !media.isCut() && !media.isCompressed() ? Uri.parse(path) : path, mViewDataBinding.ivAvatar);
                                LogUtil.d("======================================================");
