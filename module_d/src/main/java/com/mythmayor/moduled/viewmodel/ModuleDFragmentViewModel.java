 ...
 */
public class ModuleDFragmentViewModel extends ViewModel {

    private ModuleDFragmentModel mModel;

    public ModuleDFragmentViewModel() {
        mModel = new ModuleDFragmentModel();
    }

    public void getUserInfo(ModuleDFragment view, UserInfoRequest request) {
