package com.mythmayor.moduleb.presenter;
...
import com.mythmayor.moduleb.model.BFragmentModel;
 ...
 */
public class BFragmentPresenter extends BasePresenter<BFragmentContract.View> implements BFragmentContract.Presenter {

    private BFragmentContract.Model mModel;

    public BFragmentPresenter() {
        mModel = new BFragmentModel();
    }
