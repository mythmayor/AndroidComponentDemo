 ...
 */
public class ModuleBFragmentPresenter extends BasePresenter<ModuleBFragmentContract.View> implements ModuleBFragmentContract.Presenter {

    private ModuleBFragmentContract.Model mModel;

    public ModuleBFragmentPresenter() {
